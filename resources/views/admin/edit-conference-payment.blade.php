            ...
            <form action="/admin/detail/edit/{{ $submission->id_abs_submission }}" method="post">
                ...
                <div class="file-section mt-4">
                    @if ($submission->file_pembayaran != null && $submission->user->student_card != null)
                        ...
                        <div class="input-group mb-2">
                            <a href="/admin/download/student_card/{{ $submission->user->student_card }}"><button
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id=""
                                ...
                                <option value="1" @if ($submission->status == '1') selected @endif>Accept
                                </option>
                                <option value="2" @if ($submission->status == '2') selected @endif>Reject
                                </option>
                            </select>
                        </div>
                    @elseif($submission->file_pembayaran != null && $submission->user->student_card == null)
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1">Status</label>
                            <select class="form-control" name="status" id=""
                                @if ($submission->status_bayar == 1) disabled @endif>
                                <option value="1" @if ($submission->status_bayar == 1) selected @endif>Accept
                                </option>
                                <option value="2" @if ($submission->status_bayar == 2) selected @endif>Reject
                                </option>
                            </select>
                        </div>
                    @else
